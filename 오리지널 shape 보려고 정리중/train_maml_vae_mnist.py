...
def main():
    metasampler = MnistMetaSampler(
        batch_size=5,
        meta_batch_size=7,  # 테스트 할 때 임의로 바꿔도 되나?
    ...
    with tf.Session() as sess:
        ...
        '''             
        maml.test(
            test_itr=1,   # iteration to load model (-1 for latest model) 왜 매번 테스트 개수가 달라지는지는 몰겄음
            restore_model_path='./data/maml_vae/maml_vae_19_38_03_05_22/itr_1900'
        )
